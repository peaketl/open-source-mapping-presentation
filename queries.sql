...
-- ── 2. Export a single row as GeoJSON ────────────────────────────
...
-- ── 3. Crimes within 1 mile of downtown Colorado Springs ─────────
...
-- ── 4. Five nearest crimes to a point (KNN) ──────────────────────
...
-- ── 5. Buffer — crimes inside a 2 km radius ──────────────────────
...
-- ── 6. Geographic centroid of all crimes ─────────────────────────
